...
confMat.show()
confMat.savefig("plots/confusion_matrix_layer_1_ieee_training_dataset.png")
...
roc.show()
roc.savefig("plots/roc_curve_layer1_ieee_training_dataset.png")
...
feat_imp.show()
feat_imp.savefig("plots/feature_importance_layer_1_ieee_training_dataset.png", bbox_inches="tight")
