...
trainingDataset1 = pd.read_csv("../composed_tsls/TSL1IEEE.csv")
...
# Testing Data
testingDataset1 = pd.read_csv("../testing_data-set/IEEETestDataset.csv")
...
confMat.show()
confMat.savefig("plots/confusion_matrix_layer_1_ieee_dataset_train_test.png")
...
roc.show()
roc.savefig("plots/roc_curve_layer1_ieee_dataset_train_test.png")
...
feat_imp.show()
feat_imp.savefig("plots/feature_importance_layer_1_ieee_dataset_train_test_png", bbox_inches="tight")
