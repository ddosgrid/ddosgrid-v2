...
for i in range(numberOfRuns):
    ...
    classifierLayer1 = RandomForestClassifier()
    ...
    testingDataset2.to_csv("../predicted/testdatasetAfterLayer1PerformanceRF.csv", index=False)
    ...
    # evaluate the classifier
    classifierLayer2 = RandomForestClassifier()
    ...
    maliciousTraffic.to_csv("../predicted/maliciousTrafficPerformanceRF.csv", index=False)
